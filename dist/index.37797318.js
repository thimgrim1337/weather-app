...
const getDay = (date, pattern)=>(0, _formatDefault.default)(date, pattern, {
        locale: (0, _locale.pl)
    });
...
const createDay = (dayData)=>{
    ...
    dayName.innerText = getDay((0, _dateFns.parseISO)(dayData.date), "eeeeee");
...
},{"date-fns/format":"lnm6V","date-fns/locale":"lASMG","date-fns":"9yHCA","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./Weather":"eL4LC"}],"lnm6V":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./_lib/formatDistance/index.js":"UcyGF","./_lib/formatLong/index.js":"agjWO","./_lib/formatRelative/index.js":"7ja8E","./_lib/localize/index.js":"3fug0","./_lib/match/index.js":"4j9qN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"UcyGF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var formatDistanceLocale = {
    lessThanXSeconds: {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"agjWO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../../../_lib/buildFormatLongFn/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../../../_lib/buildFormatLongFn/index.js":"h1FGd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7ja8E":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function dayAndTimeWithAdjective(token, date, baseDate, options) {
    var adjectives;
    if ((0, _indexJsDefault.default)(date, baseDate, options)) adjectives = adjectivesThisWeek;
    else if (token === "lastWeek") adjectives = adjectivesLastWeek;
    else if (token === "nextWeek") adjectives = adjectivesNextWeek;
    else throw new Error("Cannot determine adjectives for token ".concat(token));
    var day = date.getUTCDay();
...
},{"../requiredArgs/index.js":"9wUgQ","../startOfUTCWeek/index.js":"dDZbE","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3fug0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../../../_lib/buildLocalizeFn/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../../../_lib/buildLocalizeFn/index.js":"5l2rZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4j9qN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../../../_lib/buildMatchFn/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eL4LC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const getWeather = async ()=>{
    try {
        const weather = await fetch("http://api.weatherapi.com/v1/forecast.json?key=d85ae36fb9014f138aa125530231904&q=Plock&days=10&aqi=no&alerts=no");
...
const parseCurrentWeather = ({ current , forecast  })=>{
    console.log(current);
    const { last_updated_epoch: localtime , temp_c: tempC , humidity , wind_kph: windKph  } = current;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6ASXy","aOVNo"], "aOVNo", "parcelRequirebbde")
